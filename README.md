...
一个本地优先的中文个人管理工具，同时管理现金账户、基金持仓、纪念币收藏与日常健康趋势。

## 现有功能

- 现金、银行卡、支付宝、微信等个人资产账户
- 全部资产配置、风险、流动性和收益四维体检
- 基金持仓总览、占比和集中度提示
- 基金持仓手动维护
- 输入 6 位基金代码自动识别中文名称，按支付宝的“金额 + 持有收益”反推成本
- 基金目录每 7 天自动刷新并本地缓存；金额、持有收益、收益率任填两项
- 支付宝当前金额、持有收益和平台持有收益率三项原样保存，不互相反推或改写
- 同一基金代码重复录入时更新当前持仓，按日保留历史快照
- 基金可安全归档、恢复，并按日期查看历史金额、收益与收益率
- 独立数据管理总览、历史快照删除与自动回算、跨设备删除标记和只增不删的审计日志
- 纪念币藏品、数量、成本与估值统计
